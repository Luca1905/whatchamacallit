...
declare module "convex/values" {
  ...
  export interface Validator<Type = any, Optionality extends "required" | "optional" = "required", FieldType = any> {
    readonly type: Type;
...
declare module "convex/server" {
  ...
  export interface FilterBuilder<T> {
    eq<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): FilterExpression<boolean>;
    neq<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): FilterExpression<boolean>;
    gt<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): FilterExpression<boolean>;
    gte<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): FilterExpression<boolean>;
    lt<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): FilterExpression<boolean>;
    lte<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): FilterExpression<boolean>;
  ...
  export interface IndexRangeBuilder<T, IndexName extends string> {
    eq<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): IndexRange;
    gt<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): IndexRangeBuilder<T, IndexName>;
    gte<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): IndexRangeBuilder<T, IndexName>;
    lt<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): IndexRange;
    lte<FieldName extends keyof T>(field: FieldName, value: T[FieldName]): IndexRange;
  }
...
declare module "convex/react" {
  ...
  export function usePaginatedQuery<T extends GenericDocument = GenericDocument>(
    query: any,
    args: any,
  ...
  export function ConvexProvider(props: ConvexProviderProps): React.ReactElement;
  ...
  export function usePreloadedQuery<T = any>(
    preloadedQuery: any
  ): T;
}
...
declare module "convex/react-clerk" {
  ...
  export interface UseAuth {
    ...
    getToken: (options?: { forceRefreshToken?: boolean }) => Promise<string | null>;
  }
  ...
  export function ConvexProviderWithClerk(props: ConvexProviderWithClerkProps): React.ReactElement;
}
